...
source=("${pkgname}::git+https://github.com/colmap/colmap.git${_fragment}"
        ...
        "onnxruntime.install.patch"
        )
sha256sums=('a258776588080ad6f789650ef84d5a668b25fc51503ba48604183ac83f740cad'
            ...
            'ef725953ad7ef3523230c96d51930087ac7c179112683ba65e1f4f499b2d2b60')

prepare() {
  sed -e '1 i\#include <cassert>' -i "${srcdir}"/${pkgname}/src/colmap/sfm/observation_manager.cc
  git -C "${srcdir}"/${pkgname} apply -v "${srcdir}"/onnxruntime.install.patch
}
